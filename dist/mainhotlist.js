...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/08f0bee2dfa70deb4c15b9b1b3f62de2', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/08f0bee2dfa70deb4c15b9b1b3f62de2',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/hot_item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    "ref": function () {return this.hotitem.seq},
	    "title": function () {return this.hotitem.name}
	  },
	  "children": [
	    {
	      "type": "div",
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "src": function () {return 'https://image.taoguba.com.cn' + (this.getImageurl())}
	              }
	            }
	          ]
	        },
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "text",
	                  "classList": function () {return ['textClass-' + (this.skinType)]},
	                  "attr": {
	                    "value": function () {return this.hotitem.name}
	                  }
	                }
	              ]
	            },
	            {
	              ...
	              "children": [
	                {
	                  "type": "text",
	                  "classList": function () {return ['numclass-' + (this.skinType)]},
	                  "attr": {
	                    "value": function () {return (this.hotitem.topicReplyNum) + '讨论  ' + (this.hotitem.topicViewNum) + '阅读'}
	                  }
	                }
	              ]
	            }
	    ...
	    {
	      "type": "div",
	      "classList": function () {return ['lineClass-' + (this.skinType)]}
	    }
	  ]
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        changeSkin: function changeSkin(skinTypes) {
	            var cskinType = this.$getConfig().skinType;
	            if (cskinType == undefined) {
	                cskinType = taoguba.getUrlParam('skinType');
	            }
	        ...
	        openzhuanti: function openzhuanti(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API = {
	    ...
	    getFocusList: "free/topic/getFocusList" };
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        ...
	        "leftimage": function () {return this.leftImg}
	      }
	    },
	    {
	      "type": "list",
	      ...
	      "children": [
	        {
	          "type": "refresh",
	          "classList": function () {return ['refresh-view-' + (this.skinType)]},
	          "attr": {
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.isdisplay},
	          "children": [
	            {
	              "type": "taoguba-wxc-panel",
	              "attr": {
	                "title": "最新热议",
	                "type": function () {return this.skinType}
	              }
	        ...
	        },
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.hotArrayTop},
	            "value": "hottopitem"
	          },
	          "shown": function () {return this.isdisplay},
	          "children": [
	            {
	              ...
	              "id": "sub",
	              "attr": {
	                "hotitem": function () {return this.hottopitem},
	        ...
	        },
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.hotArray},
	            "value": "hotitem"
	          },
	          "children": [
	            {
	              ...
	              "id": "sub1",
	              "attr": {
	                "hotitem": function () {return this.hotitem},
	                "skintype": function () {return this.skinType}
	              }
	            }
	          ]
	          ...
	          "children": [
	            {
	              "type": "text",
	              "classList": function () {return ['refresh-arrow', 'refresh-arrow-' + (this.skinType)]},
	              "shown": function () {return this.showLoading==='hide'},
	              "attr": {
	                "value": "加载更多"
	              }
	            },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        changeShin: function changeShin(cskinType) {
	            if (cskinType == undefined) {
	                cskinType = taoguba.getUrlParam('skinType');
	            }
	            if (cskinType == undefined) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        ondropmenu: function ondropmenu(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/taoguba-wxc-panel', [], function(__weex_require__, __weex_exports__, __weex_module__) {
