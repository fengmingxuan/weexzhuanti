...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/c25425c35807535c8ec7d650c2a0ea28', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/c25425c35807535c8ec7d650c2a0ea28',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/zhuanti_item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.home_dian_zan}
	                  }
	                },
	                {
	                  "type": "text",
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return this.home_ping_lun}
	                  }
	                },
	                {
	                  "type": "text",
	  ...
	  "children": [
	    {
	      ...
	      "attr": {
	        "title": function () {return this.title},
	        "ref": function () {return this.focusSeq},
	    ...
	    },
	    {
	      "type": "we-dropdown",
	      "id": "we-dropdown-id",
	      "classList": function () {return ['dropdown', 'content_class-' + (this.skinType)]},
	      "attr": {
	        "type": function () {return this.skinType},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        ondropmenu: function ondropmenu() {
	            console.log('zhuanti == ondropmenu');
	            this.$vm('we-dropdown-id').switchView();
	        },

	        onDropDownItem: function onDropDownItem(position) {
	        ...
	        getCurrentSortType: function getCurrentSortType() {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  "type": "div",
	  "classList": function () {return ['select-container', 'options-' + (this.type)]},
	  "children": [
	    {
	      "type": "div",
	      "classList": function () {return ['content', 'options-' + (this.type)]},
	      "children": [
	        {
	          "type": "content"
	        }
	      ...
	      "children": [
	        {
	          ...
	          "classList": function () {return ['cell', 'cell_border-color-' + (this.type)]},
	          "attr": {
	          ...
	          "children": [
	            {
	              "type": "text",
	              "classList": function () {return ['name', 'name-' + (this.type), this.id==this.statusId?'current':'']},
	              "attr": {
